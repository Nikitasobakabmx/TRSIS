package com.laba.two.restfull.DataBaseExecutor;
...
public class DataBaseExecutor {
    ...
    private String DATABASE_URL = "jdbc:postgresql://localhost:5432/game_shop";
    private String DATABASE_USER = "nikittosii";
    ...
    public void change(String id, String name, String studio, String cost, String photo, String description) throws SQLException{
        ...
        statement = connection.createStatement();
        String query = String.format(
                "UPDATE %1$s SET (id, name, studio_name, cost, photo, description) " + // tak delat' nel'za
                        "= (%5$s, '%2$s', '%3$s', '%4$s', %6$s, %7$s) WHERE id=%5$s;",
